...
public class LosePlanQuestionNormalFragment extends Fragment {
...
//    FancyButton btn_next;
    ...
    public LosePlanQuestionNormalFragment() {
        super();
    }

    @SuppressWarnings("unused")
    public static LosePlanQuestionNormalFragment newInstance(Bundle bundle) {
        LosePlanQuestionNormalFragment fragment = new LosePlanQuestionNormalFragment();

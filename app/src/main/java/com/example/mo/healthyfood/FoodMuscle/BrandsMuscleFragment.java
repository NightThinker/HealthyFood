...
public class BrandsMuscleFragment extends Fragment {

    FancyButton btnFastFood,btnSweet,btnFruit,btnDrink,btnSuper,btnOther;

    FoodMuscleActivity foodMuscleActivity;
    public BrandsMuscleFragment() {
        super();
    }

    @SuppressWarnings("unused")
    public static BrandsMuscleFragment newInstance(Bundle args) {
        BrandsMuscleFragment fragment = new BrandsMuscleFragment();
  //      Bundle args = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_muscle_food_brands, container, false);
        ...
        btnFastFood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                foodMuscleActivity.onShowListFood(bundle);
